...
The packages in the `random_numbers` repository were released into the `foxy` distro by running `/usr/bin/bloom-release --rosdistro foxy --track foxy random_numbers --edit` on `Tue, 07 Jul 2020 23:57:41 -0000`
